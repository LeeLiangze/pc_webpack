		...
		<tr>
			<td>
				<div class="jf-form columns-1">
					<ul id="jf-addStaff" class="jf-form-item">
						<li>
            				<span style="width:120px;margin-right:10px;">员工账号</span>
            					<span>
            						<input id="staffId" type="text" value="" autofocus="true" onfocus="this.value=''" onblur="if(this.value==''){this.value='请输入员工账号'}"/>
            					</span>
        				</li>
        				<li>
            				<span style="width:120px;margin-right:10px;">员工姓名</span>
