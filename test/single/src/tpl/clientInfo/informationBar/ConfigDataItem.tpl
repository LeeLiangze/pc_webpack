<div id="ConfigInfoBar" class="ConfigInfoBar">
    <div class="ConfigDataItem_zTree">
         <div class="bar_genre  btn-blue btn" id="bar_genre">新增类别</div>
         <div class="bar_dataItem  btn-blue btn" id="bar_dataItem">新增信息项</div>
         <div style="clear:both"></div>
         <div id="bar_zTree" class="bar_zTree"></div>
    </div>   
     <ul class="bar_ul">
        <li>
       ...
       <div class="bar_submit btn btn-blue">保存</div>
       <div class="bar_reset btn btn-blue">重置</div>
       <div class="bar_delete btn btn-blue">删除</div>
      </ul>
</div>