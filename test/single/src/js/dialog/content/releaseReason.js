...
function(Util,Compts,MediaConstants,tpl) { 
  ...
  var opserialno;
    ...
    reasonComm: function(){
      ...
      //除去微博积压消息释放时不下发满意度，其余渠道均下发
       if(callingInfo.getReqEvaluate() != '05'&&(callingInfo.getMediaType()!=MediaConstants.MICROBLOGGING_TYPE || (callingInfo.getMediaType() == MediaConstants.MICROBLOGGING_TYPE && calledNo != MediaConstants.MICROBLOGGING_NON_REAL_TIME_CALLEDNO))&&sessionStatus != "04"){
