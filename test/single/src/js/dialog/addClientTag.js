         ...
         function(Util, tpl) {
			...
			var mediaTypeID = "";
 			...
 			var eventInit = function()
 			{
 				...
 				{
 					for(var i=0,len=clientTags.length;i<len;i++){
 						var clientTag = clientTags[i];
 						clientTag =  JSON.parse(clientTag);
 						if(clientTag.tagName == ""){
 							_index.popAlert("保存标签内容不能为空！");
 							return;
 						}
 					}
					...
					if(btn == 0 || (_index.queue.myBrowser()=="IE"&&btn == 1)){
						...
						if(strlen(tagText_trim.split(""))>12){
							 ...
							 for(var i=0;i<tagText_trim.split("").length;i++){
								 tagText_trim = tagText_trim.replace(/\s/g,"").replace(/[\.\,\;\!\@\#\$\%\^\&\*\(\)\{\}\[\]\:\"\'\<\>\?\\\/\|\`\~\-\=\_\+\u3002\uff1f\uff01\uff0c\u3001\uff1b\uff1a\u201c\u201d\u2018\u2019\uff08\uff09\u300a\u300b\u3008\u3009\u3010\u3011\u300e\u300f\u300c\u300d\ufe43\ufe44\u3014\u3015\u2026\u2014\uff5e\ufe4f\uffe5]/g,"").substring(0,tagText_trim.length-1);
								 if(strlen(tagText_trim.split(""))<=12){
									 break;
								 }
							 }
						...
						if(tagText_trim!=""&&strlen(tagText_trim.split("")) <= maxlength){
							...
							if(tagText_trim.search(/\s/)>-1){
								$("#addClientTag_textTag",$el).val(tagText_trim.replace(/\s/g,"").replace(/[\.\,\;\!\@\#\$\%\^\&\*\(\)\{\}\[\]\:\"\'\<\>\?\\\/\|\`\~\-\=\_\+\u3002\uff1f\uff01\uff0c\u3001\uff1b\uff1a\u201c\u201d\u2018\u2019\uff08\uff09\u300a\u300b\u3008\u3009\u3010\u3011\u300e\u300f\u300c\u300d\ufe43\ufe44\u3014\u3015\u2026\u2014\uff5e\ufe4f\uffe5]/g,""));
							}
							tagText_trim = tagText_trim.replace(/\s/g,"").replace(/[\.\,\;\!\@\#\$\%\^\&\*\(\)\{\}\[\]\:\"\'\<\>\?\\\/\|\`\~\-\=\_\+\u3002\uff1f\uff01\uff0c\u3001\uff1b\uff1a\u201c\u201d\u2018\u2019\uff08\uff09\u300a\u300b\u3008\u3009\u3010\u3011\u300e\u300f\u300c\u300d\ufe43\ufe44\u3014\u3015\u2026\u2014\uff5e\ufe4f\uffe5]/g,"");
