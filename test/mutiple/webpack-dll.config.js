...
const dirVars = require('./../../lib/mutiple/webpack-config/base/dir-vars.config.js'); // 与业务代码共用同一份路径的配置表
...
module.exports = {
  ...
  module: require('./../../lib/mutiple/webpack-config/module.product.config.js'), // 沿用业务代码的module配置
  resolve: require('./../../lib/mutiple/webpack-config/resolve.config.js'), // 沿用业务代码的resolve配置
};
