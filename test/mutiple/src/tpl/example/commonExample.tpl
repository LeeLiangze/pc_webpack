<div class="jf-right-outer">
        ...
        <div class="searchContainer">
            ...
            <div class="jf-form columns-4">
                ...
                <li>
                    ...
                    <div>
                        <input id="fm07" class="timePicker" type="text">
                    </div>
                </li>
    ...
    <div class="jf-ctrl-bar buttonContainer">
        ...
        <a class="btn fl btnFavorite">收藏</a>
        <a class="btn fl popAlert">popAlert</a>
        <a class="btn fl getUserInfo">getUserInfo</a>
        <a class="btn fl screenLoading">screenLoading</a>
        <a class="btn fl createTab">createTab</a>
